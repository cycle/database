 ...
 * @method SelectQuery whereJsonContainsKey(string $column)
 * @method SelectQuery andWhereJsonContainsKey(string $column)
 * @method SelectQuery orWhereJsonContainsKey(string $column)
 * @method SelectQuery whereJsonDoesntContainKey(string $column)
 * @method SelectQuery andWhereJsonDoesntContainKey(string $column)
 * @method SelectQuery orWhereJsonDoesntContainKey(string $column)
 * @method SelectQuery whereJsonLength(string $column, int $length, string $operator = '=')
 * @method SelectQuery andWhereJsonLength(string $column, int $length, string $operator = '=')
 * @method SelectQuery orWhereJsonLength(string $column, int $length, string $operator = '=')
 */
