 ...
 * @method UpdateQuery whereJsonContainsKey(string $column)
 * @method UpdateQuery andWhereJsonContainsKey(string $column)
 * @method UpdateQuery orWhereJsonContainsKey(string $column)
 * @method UpdateQuery whereJsonDoesntContainKey(string $column)
 * @method UpdateQuery andWhereJsonDoesntContainKey(string $column)
 * @method UpdateQuery orWhereJsonDoesntContainKey(string $column)
