...
class OracleColumn extends AbstractColumn
{
     ...
     * @param array           $schema
     * @param DriverInterface $driver Oracle columns are bit more complex.
     * @return OracleColumn
     */
    ...
    {
        // Oracle enums are just constrained strings
        return '(' . $this->size . ')';
    }
     ...
     * @param OracleColumn  $column
     */
    private static function resolveEnum(DriverInterface $driver, OracleColumn $column): void
    {
