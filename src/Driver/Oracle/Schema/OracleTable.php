...
class OracleTable extends AbstractTable
{
    ...
    protected function fetchColumns(): array
    {
        ...
        foreach ($query->fetchAll() as $schema) {
            ...
            $result[] = OracleColumn::createInstance(
                $tableSchema . '.' . $tableName,
    ...
    protected function fetchIndexes(bool $all = false): array
    {
        ...
        foreach ($this->driver->query($query, [$tableSchema, $tableName]) as $schema) {
            ...
            $result[] = OracleIndex::createInstance($tableSchema . '.' . $tableName, $schema);
        }
    ...
    protected function fetchPrimaryKeys(): array
    {
        ...
        foreach ($this->driver->query($query, [$tableSchema, $tableName]) as $schema) {
            ...
            $index = OracleIndex::createInstance($tableSchema . '.' . $tableName, $schema);
