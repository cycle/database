...
/**
 * Oracle driver requires little bit different way to handle last insert id.
 */
class OracleInsertQuery extends InsertQuery
{
    /** @var OracleDriver */
    protected $driver;
    ...
    public function withDriver(DriverInterface $driver, string $prefix = null): QueryInterface
    {
        if (!$driver instanceof OracleDriver) {
            throw new BuilderException(
                'Oracle InsertQuery can be used only with Oracle driver'
            );
        }
