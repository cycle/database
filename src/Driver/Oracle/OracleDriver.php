...
use Cycle\Database\Driver\Oracle\Query\OracleInsertQuery;
...
/**
 * Talks to oracle databases.
 */
class OracleDriver extends Driver
{
    /**
     * Option key for default oracle schema name.
     *
    ...
    /**
     * Option key for all available oracle schema names.
     *
     * @var non-empty-string
     */
    ...
    /**
     * Default public schema name for all oracle connections.
     *
     * @var non-empty-string
     */
    ...
    public function __construct(array $options)
    {
        ...
        parent::__construct(
            ...
            new OracleCompiler('""'),
            new QueryBuilder(
                new OracleSelectQuery(),
                new OracleInsertQuery(),
                new UpdateQuery(),
                new DeleteQuery()
            )
        );
